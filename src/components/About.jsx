  ...
  return (
    <section className="about-section" id="about">
      <div className="about-left">
        ...
        <p>
          I am a highly skilled <span className="blue-highlight">.NET Full Stack Developer</span> with over 1.6 years of experience in C#, ASP.NET Core, and React JS. I specialize in API development, secure authentication, and data optimization.
        </p>
        <p>
